...
RUN apk add bash easy-rsa gcc git libc-dev mariadb mariadb-client mariadb-dev memcached nginx openssh openssl openvpn python3 python3-dev redis || exit 1
