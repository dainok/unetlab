...
LABEL usage.0 = "docker run -d -h router --ip 172.16.0.3 --name router --network workload-net -p 5005:5005 -p 5443:5443 --restart always --env API=zqg81ge585t0bt3qe0sjj1idvw7hv7vfgc11dsq6 --env CONTROLLER=1.1.1.1 --env ROUTERID=0 dainok/router"
