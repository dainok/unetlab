...
CELERY_BEAT_SCHEDULE = {
    'cancel-stale-tasks': {
        'task': 'task.tasks.cancel_stale_tasks',
...
SITE_META = {
    ...
    'description': (
        'UNetLab is a modular and extensible orchestration platform tailored for virtual network environments. '
        'It provides centralized control over distributed compute resources, enabling automated provisioning, '
        'scheduling, and lifecycle management of virtual nodes and jobs. Designed for testing and production, '
        'UNetLab ensures a scalable and secure foundation for building reproducible network labs and automation '
        'pipelines.'
    ),
    'keywords': [
        'virtualization',
        ...
        'dropdown': [
            ...
            },
            {
                ...
                'svg': (
                    ...
                    '2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 '
                    '0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 '
                    ...
                    '1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z" />'
            ...
            },
            {
                ...
                'svg': (
                    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" '
                    'stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" '
                    'class="icon icon-tabler icons-tabler-outline icon-tabler-key"><path stroke="none" '
                    'd="M0 0h24v24H0z" fill="none" />'
                    '<path d="M16.555 3.843l3.602 3.602a2.877 2.877 0 0 1 0 4.069l-2.643 2.643a2.877 2.877 0 0 1 '
                    '-4.069 0l-.301 -.301l-6.558 6.558a2 2 0 0 1 -1.239 .578l-.175 .008h-1.172a1 1 0 0 1 -.993 '
                    '-.883l-.007 -.117v-1.172a2 2 0 0 1 .467 -1.284l.119 -.13l.414 -.414h2v-2h2v-2l2.144 '
                    '-2.144l-.301 -.301a2.877 2.877 0 0 1 0 -4.069l2.643 -2.643a2.877 2.877 0 0 1 4.069 0z" />'
        ...
        'dropdown': [
            {
                ...
                'svg': (
                    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" '
                    'stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" '
                    'class="icon icon-tabler icons-tabler-outline icon-tabler-clipboard"><path stroke="none" '
                    'd="M0 0h24v24H0z" fill="none" /><path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 '
                    '-2v-12a2 2 0 0 0 -2 -2h-2" /><path d="M9 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 '
                    '2h-2a2 2 0 0 1 -2 -2z" /></svg>'
                ),
                'view': 'lab_list',
            },
            #         {
        ...
        'dropdown': [
            ...
            },
            {
                ...
                'svg': (
                    ...
                    '<path d="M9 7h4" />'
                    '<path d="M9 11h4" />'
                    '<path d="M18.42 12.61a2.1 2.1 0 0 1 2.97 2.97l-6.39 6.42h-3v-3z" /></svg>'
                ),
                'url': '#tbd',
            },
            {
            ...
            },
            {
                ...
                'svg': (
                    ...
                    '<path d="M8 9h8" />'
                    '<path d="M8 13h6" />'
                    '<path d="M18 4a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-5l-5 3v-3h-2a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 '
                    '-3h12z" /></svg>'
                ),
                'url': '#tbd',
            },
            ...
            },
            {
                ...
                'svg': (
                    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" '
                    'stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" '
                    'class="icon icon-inline me-1 icon-2"><path d="M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 '
                    '-6.566a5 5 0 1 1 7.5 6.572" /></svg>'
                ),
