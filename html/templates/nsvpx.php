...
/**
 * html/templates/nsvpx.php
 *
 * nsvpx template for UNetLab.
 *
 * LICENSE:
 *
...
$p['name'] = 'nsvpx';              // Can be empty
$p['icon'] = 'Load Balancer.png';  // Can be empty, or a icon inside /opt/unetlab/html/images/icons/
