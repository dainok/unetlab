...
/**
 * html/templates/vwlc.php
 *
 * vwlc template for UNetLab.
 *
 * LICENSE:
 *
...
$p['qemu_arch'] = 'x86_64';
$p['qemu_options'] = '-machine type=pc-1.0,accel=kvm -serial mon:stdio -nographic -nodefconfig -nodefaults -rtc base=utc -no-shutdown';
?>
